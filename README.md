...
- `CE04 PR-B — Entity Linking + Retrieval + Authority Ranking`: PASS / FINAL REVIEW PENDING.
- Current PR: `CE04 PR-B — Entity Linking + Retrieval + Authority Ranking`.
- Next planned slice: `CE04 PR-C — Production ResearchRouter + Provider Adapters` — PLANNED / NOT STARTED.
