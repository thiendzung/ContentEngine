...
async def _build_angle_model_input(
    ...
    *,
    ...
    if editorial_contract is not None:
        ...
        if (
            variant is None
            or variant.content_case_id != run.content_case_id
            or variant.content_role != editorial_contract.role
        ):
            raise AngleGenerationError("angle_locale_variant_role_mismatch")
