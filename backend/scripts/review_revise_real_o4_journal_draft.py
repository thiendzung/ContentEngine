"""Review/revise one real O4 Journal locale draft into an immutable next version."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Review/revise one exact immutable real O4 Journal locale draft into "
            "a zero-unresolved next draft version."
        )
    )
